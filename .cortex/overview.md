...
- **`permissions`** — Permission bits a proposal type holds in `ProposalConfig.permissions`; `dao::assert_permitted<P>` checks them (controller requests are privileged and pass)
